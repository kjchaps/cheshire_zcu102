...
void setup_array(char src_id, uint32_t valToWrite, const char * ew_full, uint32_t size, uint32_t stride, uint32_t array_type);
uint32_t runTest(uint32_t test_num); 
void setup(const char *in_file); 
uint32_t calc_arr_end(uint32_t ew, uint32_t size, uint32_t type); 
void reset_array_allocator();


void setup_1D(char src_id, uint32_t valToWrite, const char * ew_full, uint32_t size,uint32_t special_rule);
...
void write_test_array_1D_u(UINTPTR base_addr,
                         ...
                         uint32_t width,
                         uint32_t stride); 
void setup_1D_u(char src_id, uint32_t valToWrite, uint32_t ew, uint32_t size,
              ...
              void write_test_array_1D_fp(UINTPTR base_addr,
                            ...
                            uint32_t width,
                            uint32_t stride); 
void setup_1D_fp(char src_id, uint32_t valToWrite, uint32_t ew, uint32_t size,
              uint32_t special_rule); 
