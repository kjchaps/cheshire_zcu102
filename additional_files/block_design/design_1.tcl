...
proc create_root_design { parentCell } {
  ...
  set cheshire_clk [ create_bd_port -dir O -type clk cheshire_clk ]
  set cheshire_rst [ create_bd_port -dir O -from 0 -to 0 -type rst cheshire_rst ]
...
\
  ...
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_ports S01_AXI] [get_bd_intf_pins smartconnect_0/S01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets S01_AXI_1] [get_bd_intf_ports S01_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net rst_ddr4_0_300M_peripheral_reset  [get_bd_pins rst_ddr4_0_300M/peripheral_reset] \
  [get_bd_ports cheshire_rst]

  # Create address segments
  assign_bd_address -offset 0x000480000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000480000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces S01_AXI] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
