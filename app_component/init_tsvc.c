...
void full_array_setup(char * test_name, char * ew_full, uint32_t arrLen, int32_t stride, int print_to_file){
    //xil_printf("ew_full_tsvc = %s\r\n", ew_full);
    reset_array_allocator();
    if(strcmp(test_name, "rvvTest") == 0){ //fix rvvTest on Cheshire later
        setup_1D('a', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('b', WRITE_RAND, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('c', WRITE_RAND, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file);
    }
    else if(strcmp(test_name, "s000") == 0){
        setup_1D('X', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('Y', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
    }
    else if(strcmp(test_name, "s121") == 0){
        setup_1D('a', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('b', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
    }
        ...
        setup_1D('a', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('b', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('c', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file);
    }
        ...
        setup_1D('a', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
    }
    else if(strcmp(test_name, "s211") == 0){
        setup_1D('a', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('b', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('c', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file);
        setup_1D('d', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('e', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file);
    }
        ...
        setup_1D('a', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('b', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('c', WRITE_ONES, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); //later make SPECIAL_SET_FIRST_ONE? or keep as 1s
    }
    else if(strcmp(test_name, "s1281") == 0){
        setup_1D('a', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('b', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('c', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file);
        setup_1D('d', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file);
        setup_1D('e', WRITE_ZERO, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
    }
    ...
    //tsvc
        ...
        setup_1D('b', WRITE_RAND, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file); 
        setup_1D('c', WRITE_RAND, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file);
        setup_1D('d', WRITE_RAND, ew_full, arrLen, SPECIAL_NONE, test_name, print_to_file);
    }
    ...
    //must set last element to -1
        ...
        setup_1D('a', WRITE_ZERO, ew_full, arrLen, SPECIAL_SET_LAST_NEG_ONE, test_name, print_to_file); 
    }
    /*
